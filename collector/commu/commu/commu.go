...
type Calculator interface {
  ...
  //  - Operationid
  //  - Jsonconfig
  Doconfig(ctx context.Context, commandid int32, operationid int32, jsonconfig string) (r int32, err error)
...
//  - Operationid
//  - Jsonconfig
func (p *CalculatorClient) Doconfig(ctx context.Context, commandid int32, operationid int32, jsonconfig string) (r int32, err error) {
  var _args6 CalculatorDoconfigArgs
  _args6.Commandid = commandid
  _args6.Operationid = operationid
  _args6.Jsonconfig = jsonconfig
  var _result7 CalculatorDoconfigResult
  if err = p.Client_().Call(ctx, "doconfig", &_args6, &_result7); err != nil {
    return
  }
...
func (p *CalculatorClient) Zip(ctx context.Context) (err error) {
  var _args8 CalculatorZipArgs
  if err := p.Client_().Call(ctx, "zip", &_args8, nil); err != nil {
    return err
  }
  return nil
}
...
func NewCalculatorProcessor(handler Calculator) *CalculatorProcessor {
  self9 := &CalculatorProcessor{sharedlib.NewSharedServiceProcessor(handler)}
  self9.AddToProcessorMap("ping", &calculatorProcessorPing{handler:handler})
  self9.AddToProcessorMap("add", &calculatorProcessorAdd{handler:handler})
  self9.AddToProcessorMap("calculate", &calculatorProcessorCalculate{handler:handler})
  self9.AddToProcessorMap("doconfig", &calculatorProcessorDoconfig{handler:handler})
  self9.AddToProcessorMap("zip", &calculatorProcessorZip{handler:handler})
  return self9
}
...
type calculatorProcessorDoconfig struct {
  handler Calculator
}

func (p *calculatorProcessorDoconfig) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := CalculatorDoconfigArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
    oprot.WriteMessageBegin("doconfig", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush(ctx)
    return false, err
  ...
  iprot.ReadMessageEnd()
  result := CalculatorDoconfigResult{}
var retval int32
  var err2 error
  if retval, err2 = p.handler.Doconfig(ctx, args.Commandid, args.Operationid, args.Jsonconfig); err2 != nil {
    x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing doconfig: " + err2.Error())
    oprot.WriteMessageBegin("doconfig", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush(ctx)
  ...
  if err2 = oprot.WriteMessageBegin("doconfig", thrift.REPLY, seqId); err2 != nil {
    err = err2
  }
  if err2 = result.Write(oprot); err == nil && err2 != nil {
    err = err2
...
//  - Operationid
//  - Jsonconfig
type CalculatorDoconfigArgs struct {
  Commandid int32 `thrift:"commandid,1" db:"commandid" json:"commandid"`
  Operationid int32 `thrift:"operationid,2" db:"operationid" json:"operationid"`
  Jsonconfig string `thrift:"jsonconfig,3" db:"jsonconfig" json:"jsonconfig"`
}

func NewCalculatorDoconfigArgs() *CalculatorDoconfigArgs {
  return &CalculatorDoconfigArgs{}
}


func (p *CalculatorDoconfigArgs) GetCommandid() int32 {
  return p.Commandid
}

func (p *CalculatorDoconfigArgs) GetOperationid() int32 {
  return p.Operationid
}

func (p *CalculatorDoconfigArgs) GetJsonconfig() string {
  return p.Jsonconfig
}
func (p *CalculatorDoconfigArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *CalculatorDoconfigArgs)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.Commandid = v
...
func (p *CalculatorDoconfigArgs)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Operationid = v
...
func (p *CalculatorDoconfigArgs)  ReadField3(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 3: ", err)
} else {
  p.Jsonconfig = v
...
func (p *CalculatorDoconfigArgs) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("doconfig_args"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
    if err := p.writeField2(oprot); err != nil { return err }
...
func (p *CalculatorDoconfigArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("commandid", thrift.I32, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:commandid: ", p), err) }
  if err := oprot.WriteI32(int32(p.Commandid)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.commandid (1) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 1:commandid: ", p), err) }
  return err
}

func (p *CalculatorDoconfigArgs) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("operationid", thrift.I32, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:operationid: ", p), err) }
  if err := oprot.WriteI32(int32(p.Operationid)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.operationid (2) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 2:operationid: ", p), err) }
  return err
}

func (p *CalculatorDoconfigArgs) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("jsonconfig", thrift.STRING, 3); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:jsonconfig: ", p), err) }
  if err := oprot.WriteString(string(p.Jsonconfig)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.jsonconfig (3) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 3:jsonconfig: ", p), err) }
  return err
}

func (p *CalculatorDoconfigArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("CalculatorDoconfigArgs(%+v)", *p)
}

// Attributes:
//  - Success
type CalculatorDoconfigResult struct {
  Success *int32 `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewCalculatorDoconfigResult() *CalculatorDoconfigResult {
  return &CalculatorDoconfigResult{}
}

var CalculatorDoconfigResult_Success_DEFAULT int32
func (p *CalculatorDoconfigResult) GetSuccess() int32 {
  if !p.IsSetSuccess() {
    return CalculatorDoconfigResult_Success_DEFAULT
  }
return *p.Success
}
func (p *CalculatorDoconfigResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *CalculatorDoconfigResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *CalculatorDoconfigResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
  p.Success = &v
...
func (p *CalculatorDoconfigResult) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("doconfig_result"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField0(oprot); err != nil { return err }
  }
...
func (p *CalculatorDoconfigResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.I32, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Success)); err != nil {
...
func (p *CalculatorDoconfigResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("CalculatorDoconfigResult(%+v)", *p)
}
