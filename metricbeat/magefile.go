...
import (
	...
	metricbeat "github.com/codragonzuo/beats/metricbeat/scripts/mage"

	// register kubernetes runner
	_ "github.com/codragonzuo/beats/dev-tools/mage/kubernetes"
	...
	// mage:import
	_ "github.com/codragonzuo/beats/dev-tools/mage/target/dashboards"
	// mage:import
	_ "github.com/codragonzuo/beats/dev-tools/mage/target/docs"
	// mage:import
	_ "github.com/codragonzuo/beats/dev-tools/mage/target/pkg"
	// mage:import
	"github.com/codragonzuo/beats/dev-tools/mage/target/test"
	// mage:import
	"github.com/codragonzuo/beats/dev-tools/mage/target/unittest"
	// mage:import
	_ "github.com/codragonzuo/beats/dev-tools/mage/target/compose"
	// mage:import
	_ "github.com/codragonzuo/beats/metricbeat/scripts/mage/target/metricset"
)
...
func MockedTests(ctx context.Context) error {
	...
	params.ExtraFlags = []string{"github.com/codragonzuo/beats/metricbeat/mb/testing/data/."}
