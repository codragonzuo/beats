...
import (
	...
	"github.com/codragonzuo/beats/libbeat/api"
	...
	svc "github.com/codragonzuo/beats/libbeat/service"
	"github.com/codragonzuo/beats/libbeat/version"
...
func (b *Beat) launch(settings Settings, bt beat.Creator) error {
	...
	if b.Config.MetricLogging == nil || b.Config.MetricLogging.Enabled() {
		reporter, err := log.MakeReporter(b.Info, b.Config.MetricLogging, b.Publisher)
		if err != nil {
			return err
		}
		defer reporter.Stop()
